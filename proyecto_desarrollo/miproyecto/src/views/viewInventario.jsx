  ...
  function Componentes() {
    return (
      <div>
        ...
        <label className="label1inventario" style={{ position: "absolute", top: "18%", left: "2%" }}>
          Cedula
        </label>
        ...
        <button
          ...
          onClick={() =>
            Actualizar_inventario({
              ...
              llenarTabla: () => llenarTabla({ setInventario }),
              Limpiar_campos: () =>
                Limpiar_campos({ setCedula, setProductos, setStock, setValor }),
            })
          }
        >
          Actualizar
